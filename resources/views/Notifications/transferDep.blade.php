    ...
    <body>
        ...
        <table align="center" width="850" align="center" id="main"  border="0" cellspacing="0"cellpadding="0" class="header">
            <tr>
                ...
                <td width='60%'><strong>SuperFüds</strong><br>Nit 900703907-7<br>Bogotá COLOMBIA<br>E-mail: info@superfuds.com.co</td>
                <td><strong>Traslado {!!(isset($id))?$id:0!!}</strong><br> <strong>{{$created_at}}</strong></td>
            </tr>
            <tr>
                <td><br></td>
            </tr>
