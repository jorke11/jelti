    ...
    <body>
        ...
        <table align="center" width="850" align="center" id="main"  border="0" cellspacing="0"cellpadding="0">
            <tr>
                ...
                <td><strong>Solicitud de Muestra {!!(isset($id))?$id:0!!}</strong><br> <strong>{{$created_at}}</strong></td>
            </tr>
            <tr>
                <td><br></td>
            </tr>
            <tr>
                <td colspan="2">Se generó una peticion de Muestra por parte de <b>{{(isset($name))?$name:''}} {{(isset($last_name))?$last_name:''}} 
                </td>
            </tr>
        </table>
        <br>
