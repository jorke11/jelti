            ...
            <div class="row">
                <div class="col-lg-2 col-lg-offset-3">
                    <div class="form-group">
                        <label for="title" class="control-label">Supplier</label>
...
<div class="row">
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-body">
                @include('Report.ProfileSupplier.repurchase')
            </div>
        </div>
    </div>
</div>
...
{!!Html::script('js/Report/ProfileSupplier.js')!!}
