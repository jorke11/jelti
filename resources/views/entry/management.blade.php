        ...
        <div class="row">
            <div class="col-lg-2">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control input-entry input-sm" id="consecutive" name='consecutive' value="0001" >
                </div>
            </div>
            ...
            <div class="col-lg-2">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control input-entry input-sm form_datetime" id="created" name='created' value="<?php echo date("Y-m-d H:i") ?>" >
                </div>
            </div>
            <div class="col-lg-2">
                <div class="form-group">
                    <label for="email">Bill:</label>
                    <input type="text" class="form-control input-entry input-sm" id="bill" name='bill'>
                </div>
            </div>
            <div class="col-lg-2">
                <div class="form-group">
                    <label for="email">Description:</label>
                    <input type="text" class="form-control input-entry input-sm" id="description" name='description'>
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control input-entry input-sm" id="name_supplier" readonly="">
                </div>
            </div>
            ...
            <div class="col-lg-2">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control input-entry input-sm" id="address_supplier" readonly="">
                </div>
            </div>
            <div class="col-lg-2">
                <div class="form-group">
                    <label for="email">Phone:</label>
                    <input type="text" class="form-control input-entry input-sm" id="phone_supplier" readonly="">
                </div>
            </div>
