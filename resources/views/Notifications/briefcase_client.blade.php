<html>
    <head>
        ...
        <style type="text/css">
            body{
                font-family: "Helvetica", "Lucida Grande", Sans-Serif;color: #4e4848;
            }
    ...
    <body>
        <table align="center" width="550" align="center" id="main"  border="0" cellspacing="0"cellpadding="0">
            <tr>
                ...
                <td width='60%'></td>
                <td width='15%'><img src="../../images/superfuds.png" style="display:block"></td>
            </tr>
            ...
            <tr>
                <td width="60%" style="padding-left: 50px;padding-top: 80px;padding-bottom: 0">
                    <table width="100%">
                        ...
                        <tr>
                            <td><span class="title-client">Bogotá, Colombia</span></td>
                        </tr>
                    </table>
        ...
        <table align="center" width="550" align="center" id="main"  border="0" cellspacing="0"cellpadding="0">
            <tr>
                <td align="center" style=" letter-spacing: 1px;font-size:18px;font-weight: bold ">Queremos recordarte que en tu ultimo estado de cuenta se presenta un saldo vencido</td>
            </tr>
        </table>
        <br>
        ...
        <table align="center" width="550"align="center" id="main"  border="0" cellspacing="0"cellpadding="0">
            <tr >
                <td >
                    <table  width="100%">
                        <tr >
                            <td align="center">Maritza Borras</td>
                        </tr>
                        <tr>
                            <td align="center">Contabilidad</td>
                        </tr>
                        <tr>
                            <td align="center">contabilidad@superfuds.com.co</td>
                        </tr>
                        <tr>
                            <td align="center">Cel: 310 251 6486</td>
                        </tr>
                        <tr>
                            <td align="center">www.superfuds.com</td>
                        </tr>
                    </table>
                <td>
            </tr>
